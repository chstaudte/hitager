...
namespace Hitager
{
    partial class FormHexEditor
    {
        ...
        private void InitializeComponent()
        {
			...
			this.tabHitagS = new System.Windows.Forms.TabPage();
			...
			this.hitagS = new Hitager.HitagS();
			...
			this.tabControl.Controls.Add(this.tabHitagS);
			...
			// tabHitagS
			// 
			this.tabHitagS.Controls.Add(this.hitagS);
			resources.ApplyResources(this.tabHitagS, "tabHitagS");
			this.tabHitagS.Name = "tabHitagS";
			this.tabHitagS.UseVisualStyleBackColor = true;
			// 
			// tabPageBmw
			// 
			...
			this.serialDebugger1.FormHexEditor = null;
			...
			// hitagS
			// 
			resources.ApplyResources(this.hitagS, "hitagS");
			this.hitagS.Name = "hitagS";
			this.hitagS.debugUpdated += new System.EventHandler(this.debugUpdatedEventHandler);
			...
			this.tabHitagS.ResumeLayout(false);
		...
		private System.Windows.Forms.TabPage tabHitagS;
		private HitagS hitagS;
	}
}